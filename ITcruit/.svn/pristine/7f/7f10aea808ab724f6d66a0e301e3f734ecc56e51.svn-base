...
@Data
public class EntSttsPaginationVO<T> {
	...
	public EntSttsPaginationVO() {}
	
	// PaginationInfoVO 객체를 만들 때, 한 페이지당 게시글 수와 페이지 블록 수를
	// 원하는 값으로 초기화 할 수 있다.
	
	public EntSttsPaginationVO(int screenSize, int blockSize) {
		super();
	...
	public String getpagingHTML() {
		 ...
		 */
		if(startPage > 1) {
			html.append("<li class='page-item mb-0'><a href = '' class='page-link' data-entsttspage='"
		...
		if(endPage < totalPage) {
			html.append("<li class='page-item'><a href='' class='page-link' data-entsttspage='"
