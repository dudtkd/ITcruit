...
<div class="page-content-wrapper border">
	<div class="col-12" >
		...
		<form class="postForm" id="insertForm" method="post" action="/myPage/admin/noticeInsert.do" enctype="multipart/form-data">
		...
		<button class="cancelBtn" type="button">취소</button><br>
			<sec:csrfInput/>
		</form>
...
$(function(){
	...
	submitBtn.on("click", function(){
		...
		if($(this).text() == "수정"){
			insertForm.attr("action", "/myPage/admin/noticeUpdate.do")
		}
		insertForm.submit();
	});
