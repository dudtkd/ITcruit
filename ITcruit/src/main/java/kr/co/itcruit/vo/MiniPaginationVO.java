...
@Data
public class MiniPaginationVO<T> {
	...
	private String BBS201searchType;	// 기업 일반 검색 타입	
	private String BBS201searchWord;	// 기업 일반 검색 단어

	private String BBS202searchType;	// 기업 공지 검색 타입	
	private String BBS202searchWord;	// 기업 공지 검색 단어

	private int entNo;
	
	public MiniPaginationVO() {}
	
	// PaginationInfoVO 객체를 만들 때, 한 페이지당 게시글 수와 페이지 블록 수를
	// 원하는 값으로 초기화 할 수 있다.
	
	public MiniPaginationVO(int screenSize, int blockSize) {
		super();
	...
	public String getpagingHTML() {
		...
		html.append("<nav class='d-flex justify-content-center mb-0 ml-auto' aria-label='navigation'>");
